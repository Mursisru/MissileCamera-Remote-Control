...
`AimInputMode` in config: `Mouse` / `Keys` / `Both` (default **Both**). Rebind aim keys to WASD, numpad, or any custom `KeyboardShortcut` in `com.at747.missilecamera.remotecontrol.cfg`.
